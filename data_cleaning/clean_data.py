...
def convertir_a_normaldata(entries):
    ...
    for entry in entries:
        ...
        volume = entry.get('volume',1)  # Asigna 0 si no existe el campo 'volume'
        ...
        if abstract is not None:
            ...
            normaldata = NormalData(author=author, title=title, abstract=abstract, year=year, volume=volume, pages=pages)
