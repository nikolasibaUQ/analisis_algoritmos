...
# Abrir la página
    driver.get(
        "https://www-scopus-com.crai.referencistas.com/search/form.uri?display=basic#basic")
...
# Buscar el campo de búsqueda
    input_element = driver.find_element(
        by=By.CLASS_NAME, value="styleguide-input-module___SqPU")
    print('encontrado')
...
# presionar boton buscar
    search_button = driver.find_element(
        by=By.XPATH, value="//button[span[text()='Search']]")
    search_button.click()
...
# apply_button.click()
    ...
    documents = driver.find_element(
        by=By.CLASS_NAME, value='SearchResultsHeader-module__Qq2ZF')
    ...
    dropdown = driver.find_element(
        by=By.XPATH, value="//button[span[text()='Export']]")
    print('encontrado')
    dropdown.click()
    print('click')
    ...
    csv = driver.find_element(
        by=By.XPATH, value="//button[span[text()='BibTeX']]")
    print('encontrado')
    csv.click()
    print('click')
    ...
    fromData = driver.find_element(
        By.CSS_SELECTOR, 'input[placeholder="From"]')
    fromData.send_keys('1')

    toData = driver.find_element(
        By.CSS_SELECTOR, value="input[placeholder=To]")
    ...
    progress_bar = driver.find_element(
        By.CSS_SELECTOR, "progress.PercentageBar-module__98Jio")
